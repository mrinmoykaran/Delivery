...
public class Delivered_weekly_adapter extends RecyclerView.Adapter<Delivered_weekly_adapter.MyViewHolder> {

    private List<Weekly_model> modelList;
    ...
    public Delivered_weekly_adapter(Context context, List<Weekly_model> modemodelList, final Fragment currentFragment) {
    ...
    public Delivered_weekly_adapter(List<Weekly_model> modelList) {
        this.modelList = modelList;
    }

    @Override
    public Delivered_weekly_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_delivered_history, parent, false);
        context = parent.getContext();
        session_management = new Session_management(context);
        return new Delivered_weekly_adapter.MyViewHolder(itemView);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(Delivered_weekly_adapter.MyViewHolder holder, int position) {
        final Weekly_model mList = modelList.get(position);
